...
ribbon: DodgerBlue
description: "A financial company was compromised,They suspects that an insider helped the attacker get into the network, many systems were compromised.there are malicious tools in the network...."
categories:
  - Threat Hunting
toc: true
---
...
<img src="/assets/images/Threat Hunting/QRadar101/VirusTotal.png" style="margin-left: auto; margin-right: auto; display: block;" >
...
<br>
another way you can navigate to \‘Log Activity\’ and then edit the search with group by ‘Source IP’, then you can find the answer is <u>“192.168.20.20”</u>.
...
We know that the first infected machine is ‘192.168.10.15’ so lets start by filter by it as ‘Source IP’ and group results by ‘Protocol’.
